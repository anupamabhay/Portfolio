            ...
            >
              <div>
                ...
                <input
                  ...
                  type="text"
                  required
                  className="w-full px-4 py-3 rounded-xl bg-surface-tertiary/50 border border-edge text-content placeholder:text-content-muted/50 focus:outline-none focus:border-accent transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 rounded-xl bg-surface-tertiary/50 border border-edge text-content placeholder:text-content-muted/50 focus:outline-none focus:border-accent transition-colors resize-none"
          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-11 h-11 rounded-xl bg-surface-tertiary/50 border border-edge flex items-center justify-center text-content-muted hover:text-content hover:border-accent transition-all"
                aria-label="GitHub"
              >
